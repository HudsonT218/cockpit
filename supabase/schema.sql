...
-- ============================================================
-- work_sessions (per-project clock-in / clock-out time logs)
-- ended_at null = currently clocked in (open session).
-- ============================================================
...
-- ============================================================
-- habit_categories (user-defined groups for standalone life habits)
-- Seeded per-user in the store (Health / Mind / Home), not in SQL.
-- ============================================================
